...
-- AlterTable
ALTER TABLE "products" ADD COLUMN     "height" INTEGER NOT NULL DEFAULT 10,
ADD COLUMN     "length" INTEGER NOT NULL DEFAULT 20,
ADD COLUMN     "weight" INTEGER NOT NULL DEFAULT 300,
ADD COLUMN     "width" INTEGER NOT NULL DEFAULT 15;
...
-- CreateIndex
CREATE INDEX "orders_mpOrderId_idx" ON "orders"("mpOrderId");
